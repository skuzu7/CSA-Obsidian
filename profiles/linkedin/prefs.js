...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1779840508);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1779844108);
user_pref("app.update.lastUpdateTime.region-update-timer", 1779840508);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1779840508);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1779840538);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 1779844108);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1779840508);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{94644df2-6192-435c-86e3-337813518899}");
...
user_pref("browser.startup.lastColdStartupCheck", 1779840478);
...
user_pref("captchadetection.lastSubmission", 1779840);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECMticHc8nc5/BAg4hM6sy5Sk1w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"3d145686-b040-476c-bdcb-5de591c29718\",\"pictureinpicture@mozilla.org\":\"5a7d16dd-28b9-4949-b049-ee3623a9a57f\",\"screenshots@mozilla.org\":\"a520867c-e9e3-4ccd-a37f-32d59deb91dd\",\"webcompat@mozilla.org\":\"4d1f507a-c00e-41ca-bf3f-fb55b30385f0\",\"firefox-compact-dark@mozilla.org\":\"99152e9f-c804-4bfd-ab2b-5526fac02824\",\"addons-search-detection@mozilla.com\":\"8643e143-7351-436c-88e4-f58fcde488bd\",\"uBlock0@raymondhill.net\":\"1721609f-8f27-41bd-86e4-05648a95a711\"}");
...
user_pref("idle.lastDailyNotification", 1779840721);
...
user_pref("media.gmp-manager.lastCheck", 1779840499);
user_pref("media.gmp-manager.lastEmptyCheck", 1779840499);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.hardware-video-decoding.failed", false);
user_pref("media.peerconnection.enabled", false);
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1779840721);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1779840721190");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECKE5AYdAgn3EBAj/hzmSFbkBow==");
user_pref("storage.vacuum.last.index", 0);
user_pref("storage.vacuum.last.places.sqlite", 1779840721);
user_pref("toolkit.startup.last_success", 1779840476);
