...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1779850704);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1779854304);
user_pref("app.update.lastUpdateTime.region-update-timer", 1779850704);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1779850704);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1779850732);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 1779854304);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1779850704);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{cb4acb4e-574f-4b02-83c7-fe09153b7178}");
...
user_pref("browser.startup.lastColdStartupCheck", 1779850674);
...
user_pref("captchadetection.lastSubmission", 1779830);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECLf6c373IKCOBAi/dwa/BRkE8Q==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"f6e9c750-f1aa-4cd4-9094-cb9c919f70bb\",\"pictureinpicture@mozilla.org\":\"e87ffc23-aa37-4e28-9f25-fa36c72e020c\",\"screenshots@mozilla.org\":\"0f8a6995-2f2d-4911-a941-2796a8f69337\",\"webcompat@mozilla.org\":\"c18b22d5-0751-4d4d-a354-d82ec67b0c57\",\"firefox-compact-dark@mozilla.org\":\"5dc49637-f513-480c-8791-d1380878753e\",\"uBlock0@raymondhill.net\":\"c2710455-ec5b-4c3f-9c05-cee088461219\",\"addons-search-detection@mozilla.com\":\"98a1ca54-2a24-4293-b2ce-4c6d473cb1a7\"}");
...
user_pref("idle.lastDailyNotification", 1779850923);
...
user_pref("media.gmp-manager.lastCheck", 1779850763);
user_pref("media.gmp-manager.lastEmptyCheck", 1779850763);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.hardware-video-decoding.failed", false);
user_pref("media.peerconnection.enabled", false);
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1779850923);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1779850923026");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECA4s7eQnaIl8BAi/0WLhJxg/Qg==");
user_pref("storage.vacuum.last.index", 0);
user_pref("storage.vacuum.last.places.sqlite", 1779850923);
user_pref("toolkit.startup.last_success", 1779850672);
